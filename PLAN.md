...
### Priority 2: Role Clarity ✅ Done
Improve UX so users understand who can do what:

- [x] **Owner badge** - Show "Admin" badge near board title for owners (`src/app/b/[slug]/page.tsx`)
- [x] **Read-only status** - Make visitor status badges look non-interactive (`src/components/boards/feedback-list.tsx`)
